...
/// <summary>
/// タスク2.1のTDD: TimecodeBridge.App.csprojの構造と設定を検証
/// </summary>
public class MacOSProjectStructureTests
{
    private const string MacOSProjectPath = "../../../../../src/TimecodeBridge.App/TimecodeBridge.App.csproj";
    ...
    {
        // Arrange
        var infoPlistPath = Path.GetFullPath("../../../../../src/TimecodeBridge.App/Info.plist");

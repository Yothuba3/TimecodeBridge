...
public partial class OscTriggerPanelViewModel : ObservableObject
{
    ...
    private void ApplyGridSize()
    {
        ...
        var newRows = Math.Clamp(Rows, OscTriggerPanelManager.MinSize, OscTriggerPanelManager.MaxSize);
        var newColumns = Math.Clamp(Columns, OscTriggerPanelManager.MinSize, OscTriggerPanelManager.MaxSize);
    ...
    {
        ModalDialog.ShowMessage("送出できません", "送信先ホストが設定されていないか、すべて無効です。");
    }
}
